...
type GenericStats struct {
	...
	// ChainOpenCore0 is for S17() and S17plus()
	ChainOpenCore0  interface{} `json:"chain_opencore_0,string"`
	ChainOpenCore1  interface{} `json:"chain_opencore_1,string"`
	ChainOpenCore2  interface{} `json:"chain_opencore_2,string"`
...
type StatsS17 struct {
	...
	Temp4             int     `json:"temp4"`
	Temp5             int     `json:"temp5"`
	Temp6             int     `json:"temp6"`
	Temp7             int     `json:"temp7"`
	Temp8             int     `json:"temp8"`
	Temp9             int     `json:"temp9"`
	Temp10            int     `json:"temp10"`
	Temp11            int     `json:"temp11"`
	Temp12            int     `json:"temp12"`
	Temp13            int     `json:"temp13"`
	Temp14            int     `json:"temp14"`
	Temp15            int     `json:"temp15"`
	Temp16            int     `json:"temp16"`
	Temp2_1           int     `json:"temp2_1"`
	Temp2_2           int     `json:"temp2_2"`
	Temp2_3           int     `json:"temp2_3"`
	Temp2_4           int     `json:"temp2_4"`
	Temp2_5           int     `json:"temp2_5"`
	Temp2_6           int     `json:"temp2_6"`
	Temp2_7           int     `json:"temp2_7"`
	Temp2_8           int     `json:"temp2_8"`
	Temp2_9           int     `json:"temp2_9"`
	Temp2_10          int     `json:"temp2_10"`
	Temp2_11          int     `json:"temp2_11"`
	Temp2_12          int     `json:"temp2_12"`
	Temp2_13          int     `json:"temp2_13"`
	Temp2_14          int     `json:"temp2_14"`
	Temp2_15          int     `json:"temp2_15"`
	Temp2_16          int     `json:"temp2_16"`
	Temp3_1           int     `json:"temp3_1"`
	Temp3_2           int     `json:"temp3_2"`
	Temp3_3           int     `json:"temp3_3"`
	Temp3_4           int     `json:"temp3_4"`
	Temp3_5           int     `json:"temp3_5"`
	Temp3_6           int     `json:"temp3_6"`
	Temp3_7           int     `json:"temp3_7"`
	Temp3_8           int     `json:"temp3_8"`
	Temp3_9           int     `json:"temp3_9"`
	Temp3_10          int     `json:"temp3_10"`
	Temp3_11          int     `json:"temp3_11"`
	Temp3_12          int     `json:"temp3_12"`
	Temp3_13          int     `json:"temp3_13"`
	Temp3_14          int     `json:"temp3_14"`
	Temp3_15          int     `json:"temp3_15"`
	Temp3_16          int     `json:"temp3_16"`
	TempPcb1          string  `json:"temp_pcb1"`
	TempPcb2          string  `json:"temp_pcb2"`
	TempPcb3          string  `json:"temp_pcb3"`
	TempPcb4          string  `json:"temp_pcb4"`
