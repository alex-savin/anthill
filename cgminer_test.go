...
func TestStats2BoardsS17(t *testing.T) {
	testCaseValue := getFixture("TestStatsS17plus.json")
	// testCaseValue := getFixture("TestStatsS9.json")
	expected := &StatsS17{
		BMMiner:           "2.0.0 rwglr",
		Miner:             "35.0.1.3",
		CompileTime:       "Tue Apr 1 17:50:02 CST 2020",
		Type:              "Antminer S17+",
		Stats:             0,
		ID:                "BC50",
		Elapsed:           1189,
		...
		Temp3_15:          0,
		Temp3_16:          0,
		TempPcb1:          "55-36-56-36",
		TempPcb2:          "57-36-55-35",
		TempPcb3:          "59-37-57-36",
		TempPcb4:          "0-0-0-0",
		TempPcb5:          "0-0-0-0",
		TempPcb6:          "0-0-0-0",
		TempPcb7:          "0-0-0-0",
		...
		TempPcb15:         "0-0-0-0",
		TempPcb16:         "0-0-0-0",
		TempChip1:         "73-46-73-46",
		TempChip2:         "74-47-73-47",
		TempChip3:         "77-47-76-47",
		TempChip4:         "0-0-0-0",
		TempChip5:         "0-0-0-0",
		TempChip6:         "0-0-0-0",
		TempChip7:         "0-0-0-0",
		...
		TempChip15:        "0-0-0-0",
		TempChip16:        "0-0-0-0",
		TotalRateIdeal:    81900,
		TotalFrequencyAvg: 0,
		TotalAcn:          195,
		TotalRate:         82749.25,
		ChainRateIdeal1:   27300,
		ChainRateIdeal2:   27300,
		ChainRateIdeal3:   27300,
		ChainRateIdeal4:   0,
		ChainRateIdeal5:   0,
		ChainRateIdeal6:   0,
		ChainRateIdeal7:   0,
		...
		ChainAcn15:        0,
		ChainAcn16:        0,
		ChainAcs1:         " ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo",
		ChainAcs2:         " ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo",
		ChainAcs3:         " ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo ooooo",
		ChainAcs4:         "",
		ChainAcs5:         "",
		ChainAcs6:         "",
		ChainAcs7:         "",
		...
		Freq15:            0,
		Freq16:            0,
		MinerVersion:      "35.0.1.3",
		MinerID:           "810274467910481c",
		ChainPower1:       1115,
		ChainPower2:       1115,
		ChainPower3:       1115,
		TotalPower:        3347,
